    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tutorium Edit</h3>
            </div>
			<?php echo form_open('tutorium/edit/'.$tutorium['idTutoria']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="PERSONAidPersona" class="form-control">
								...
								{
									$selected = ($persona['idPersona'] == $tutorium['PERSONAidPersona']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="DESAPARECIDOSidDes" class="form-control">
								...
								{
									$selected = ($desaparecido['idDes'] == $tutorium['DESAPARECIDOSidDes']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<textarea name="parentesco" class="form-control" id="parentesco"><?php echo ($this->input->post('parentesco') ? $this->input->post('parentesco') : $tutorium['parentesco']); ?></textarea>
						</div>
					</div>
				</div>
			</div>
